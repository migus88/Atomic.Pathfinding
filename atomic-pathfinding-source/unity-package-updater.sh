...
# Predefined data
DESTINATION_DLL="./../atomic-pathfinding-unity/Packages/Atomic.Pathfinding/Atomic.Pathfinding.Core.dll"
PACKAGE_JSON="./../atomic-pathfinding-unity/Packages/Atomic.Pathfinding/package.json"
